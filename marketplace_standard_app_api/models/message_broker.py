...
class MessageBrokerRequestModel(BaseModel):
    ...
    body: Optional[str] = Field(None, description="The request message body encoded in base64")
...
class MessageBrokerResponseModel(BaseModel):
    ...
    body: Optional[str] = Field(None, description="The response message body encoded in base64")
